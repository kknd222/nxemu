...
private:
    ...
    bool m_is_hbl{};
    uint64_t m_main_thread_argument0{};
    uint64_t m_main_thread_argument1{};
    KProcessAddress m_main_thread_handle_write_address{};
...
public:
    ...
    void SetMainThreadStartupArguments(uint64_t argument0, uint64_t argument1, KProcessAddress main_thread_handle_write_address)
    {
        m_main_thread_argument0 = argument0;
        m_main_thread_argument1 = argument1;
        m_main_thread_handle_write_address = main_thread_handle_write_address;
    }
