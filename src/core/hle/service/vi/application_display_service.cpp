...
Result IApplicationDisplayService::GetRelayService(
    ...
    NxemuAndroidDiagnostics::RecordEvent("VI.App.GetRelayService", "binder-driver");
...
Result IApplicationDisplayService::GetSystemDisplayService(
    ...
    LOG_WARNING(Service_VI, "(STUBBED) called");
    NxemuAndroidDiagnostics::RecordEvent("VI.App.GetSystemDisplayService", "created");
...
Result IApplicationDisplayService::GetManagerDisplayService(
    ...
    LOG_WARNING(Service_VI, "(STUBBED) called");
    NxemuAndroidDiagnostics::RecordEvent("VI.App.GetManagerDisplayService", "created");
...
Result IApplicationDisplayService::OpenDisplay(Out<u64> out_display_id, DisplayName display_name) {
    ...
    NxemuAndroidDiagnostics::RecordEvent("VI.App.OpenDisplay",
                                         std::string{"name="} + display_name.data());
...
Result IApplicationDisplayService::OpenLayer(Out<u64> out_size,
    ...
    NxemuAndroidDiagnostics::RecordEvent(
        "VI.App.OpenLayer",
        "display=" + std::string(display_name.data()) + " layer_id=" +
            std::to_string(layer_id) + " aruid=" + std::to_string(aruid.pid));
...
Result IApplicationDisplayService::CreateStrayLayer(
    ...
    NxemuAndroidDiagnostics::RecordEvent(
        "VI.App.CreateStrayLayer",
        "flags=" + std::to_string(flags) + " display_id=" + std::to_string(display_id));
...
Result IApplicationDisplayService::GetDisplayVsyncEvent(
    ...
    LOG_DEBUG(Service_VI, "called. display_id={}", display_id);
    NxemuAndroidDiagnostics::RecordEvent("VI.App.GetDisplayVsyncEvent",
    ...
    *out_vsync_event = it->second.GetHandle();
    NxemuAndroidDiagnostics::RecordEvent(
        ...
        "display_id=" + std::to_string(display_id) + " event_ptr=0x" +
            fmt::format("{:X}", reinterpret_cast<uintptr_t>(it->second.GetHandle())));
