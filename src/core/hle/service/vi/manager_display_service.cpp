...
Result IManagerDisplayService::AddToLayerStack(u32 stack_id, u64 layer_id) {
    ...
    NxemuAndroidDiagnostics::RecordEvent(
        "VI.Manager.AddToLayerStack",
        "stack_id=" + std::to_string(stack_id) + " layer_id=" + std::to_string(layer_id));
    R_SUCCEED();
}
