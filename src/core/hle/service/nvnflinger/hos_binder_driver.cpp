...
Result IHOSBinderDriver::TransactParcel(s32 binder_id, u32 transaction_id,
    ...
    NxemuAndroidDiagnostics::RecordEvent(
        "Nvnflinger.Binder.TransactParcel",
        "binder_id=" + std::to_string(binder_id) +
...
Result IHOSBinderDriver::AdjustRefcount(s32 binder_id, s32 addval, s32 type) {
    ...
    NxemuAndroidDiagnostics::RecordEvent(
        "Nvnflinger.Binder.AdjustRefcount",
        "binder_id=" + std::to_string(binder_id) + " addval=" + std::to_string(addval) +
...
Result IHOSBinderDriver::GetNativeHandle(s32 binder_id, u32 type_id,
    ...
    NxemuAndroidDiagnostics::RecordEvent(
        "Nvnflinger.Binder.GetNativeHandle",
        "binder_id=" + std::to_string(binder_id) + " type_id=" + std::to_string(type_id));
