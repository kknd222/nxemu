...
public:
    ...
    bool RelocateAndCopy(uint64_t load_base, uint64_t code_offset, uint64_t code_size, uint8_t * program_image, uint32_t * image_size, EntryTrampolines * out_trampolines);
