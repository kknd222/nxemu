...
public:
    ...
    virtual VirtualFile OpenFile(std::string_view path, VirtualFileOpenMode perms);
    // Creates a new, empty file at path
    virtual VirtualFile CreateFile(std::string_view path, VirtualFileOpenMode perms);
    ...
    virtual VirtualDir OpenDirectory(std::string_view path, VirtualFileOpenMode perms);
    // Creates a new, empty directory at path
    virtual VirtualDir CreateDirectory(std::string_view path, VirtualFileOpenMode perms);
